...
TOOLS = [
    struct(
        ...
        arch = "aarch64",
        libc = "libsystem",
        url = "https://github.com/dzbarsky/toml2json/releases/download/v0.0.23/toml2json_darwin_arm64",
    ...
    struct(
        ...
        arch = "x86_64",
        libc = "libsystem",
        url = "https://github.com/dzbarsky/toml2json/releases/download/v0.0.23/toml2json_darwin_amd64",
    ...
    struct(
        ...
        arch = "aarch64",
        libc = "gnu",
        url = "https://github.com/dzbarsky/toml2json/releases/download/v0.0.23/toml2json_linux_arm64",
    ...
    struct(
        ...
        arch = "x86_64",
        libc = "gnu",
        url = "https://github.com/dzbarsky/toml2json/releases/download/v0.0.23/toml2json_linux_amd64",
